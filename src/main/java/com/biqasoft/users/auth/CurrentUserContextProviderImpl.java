...
//            }
//
//            com.biqasoft.users.useraccount.UserAccount internalUserEntity = userAccountRepository.findByUsernameOrOAuthToken(currentUser.getUsername()).block();
...
//            }
//
//            userAccount = UserAccountMapper.mapInternalToDto(internalUserEntity);
